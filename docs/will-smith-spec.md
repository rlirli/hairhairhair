...
The person page has breadcrumbs, a concise factual mini bio, a source-attributed profile image, a natural profile, and a compact newest-first appearances preview with face-cropped images, capture dates, event titles, and a link to the full `/appearances/` overview. The separate appearances overview retains the detailed source and hairstyle-observation records; its cards link back to the person record until dedicated single-appearance pages exist. Keep the bio short and factual; it is not a second editorial essay.
