...
Any v0 visuals should be original, simplified diagrams of line or loop silhouettes. They are teaching aids, not photographic exemplars, diagnostic tests, or promises that every head of hair fits one cell. Captions should repeat that mixed patterns are normal and that the chart describes pattern only.
