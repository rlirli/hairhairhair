...
export const hairstyleMedia: HairstyleMedia[] = [
  ...
  },
  {
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "blunt-bob-chin" } },
    transparentBackground: true,
  },
  {
    id: "buzz-short",
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "buzz-short" } },
  ...
  },
  {
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "buzz-textured" } },
    transparentBackground: false,
  },
  {
    id: "cropped-afro-compact",
    kind: "image",
    image: croppedAfroCompact,
    alt: "Transparent editorial reference showing a compact cropped afro with a neat silhouette.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "cropped-afro-compact" } },
    transparentBackground: true,
  },
  {
    id: "cropped-afro-full",
    kind: "image",
    image: croppedAfroFull,
    alt: "Transparent editorial reference showing a short cropped afro with rounded coily texture.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "cropped-afro-full" } },
    transparentBackground: true,
  },
  {
  ...
  },
  {
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "farrah-fawcett-cut-black" } },
    transparentBackground: true,
  },
  {
    id: "farrah-fawcett-cut-classic-feathered",
    kind: "image",
    image: farrahFawcettCutClassicFeathered,
  ...
  },
  {
    ...
    kind: "image",
    image: fivePointCutGeometricBlack,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "five-point-cut-geometric-black" } },
    transparentBackground: true,
  },
  {
    id: "five-point-cut-geometric-dark",
    kind: "image",
    image: fivePointCutGeometricDark,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "five-point-cut-geometric-dark" } },
    transparentBackground: true,
  },
  {
    id: "flat-top-coily",
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "flat-top-coily" } },
    transparentBackground: false,
  },
  {
    id: "flat-top-straight",
    kind: "image",
    image: flatTopStraight,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "flat-top-straight" } },
    transparentBackground: false,
  },
  {
    id: "freeform-locs-long",
    kind: "image",
    image: freeformLocsLong,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "freeform-locs-long" } },
    transparentBackground: true,
  },
  {
    id: "french-crop-textured-2a",
    kind: "image",
    image: frenchCropTextured2a,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "french-crop-textured-2a" } },
    transparentBackground: true,
  },
  {
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "knotless-box-braids-medium" } },
    transparentBackground: true,
  },
  {
  ...
  },
  {
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "natural-afro-deep-skin-man" } },
    transparentBackground: true,
  },
  {
    id: "natural-afro-rounded-coily",
    kind: "image",
    image: naturalAfroRoundedCoily,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "natural-afro-rounded-coily" } },
    transparentBackground: true,
  },
  {
    id: "patterned-mohawk-curved",
    kind: "image",
    image: patternedMohawkCurved,
    alt: "Transparent editorial reference showing a patterned mohawk with a curved raised crest.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "patterned-mohawk-curved" } },
    transparentBackground: true,
  },
  {
  ...
  },
  {
    ...
    kind: "image",
    image: sculptedSphericalAfroClassic,
    alt: "Fictional Black woman with a large dense black Afro shaped into a nearly spherical silhouette.",
    provenance: {
      origin: "system",
      aiGeneration: { provider: "OpenAI", promptKey: "sculpted-spherical-afro-classic" },
    },
    transparentBackground: true,
  },
  {
    ...
    kind: "image",
    image: sculptedSphericalAfroOlderMan,
  ...
  },
  {
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "taper-coily" } },
    transparentBackground: false,
  },
  {
    id: "taper-wavy",
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "taper-wavy" } },
    transparentBackground: false,
  },
  {
    id: "the-rachel-classic-layered",
    kind: "image",
    image: theRachelClassicLayered,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "the-rachel-classic-layered" } },
    transparentBackground: true,
  },
  {
    id: "the-rachel-soft-wave",
    kind: "image",
    image: theRachelSoftWave,
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "the-rachel-soft-wave" } },
    transparentBackground: true,
  },
  {
    id: "thin-mohawk-blond",
    kind: "image",
    image: thinMohawkBlond,
    alt: "Transparent editorial reference showing a thin blond mohawk with close shaved sides.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "thin-mohawk-blond" } },
    transparentBackground: true,
  },
  {
    id: "thin-mohawk-dark",
    kind: "image",
    image: thinMohawkDark,
    alt: "Transparent editorial reference showing a thin dark mohawk with close shaved sides.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "thin-mohawk-dark" } },
    transparentBackground: true,
  },
  {
    id: "top-knot-curly",
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "top-knot-curly" } },
    transparentBackground: true,
  },
  {
    id: "top-knot-tapered",
    kind: "image",
    image: topKnotTapered,
    alt: "Transparent editorial reference showing a tied top knot above a tapered perimeter.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "top-knot-tapered" } },
    transparentBackground: true,
  },
  {
    id: "twists-long",
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "twists-long" } },
    transparentBackground: false,
  },
  {
    id: "twists-short",
    ...
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "twists-short" } },
    transparentBackground: false,
  },
  {
    id: "wolf-cut-curly-medium",
    kind: "image",
    image: wolfCutCurlyMedium,
    alt: "Editorial reference showing a dark-skinned woman with a medium-length curly wolf cut.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "wolf-cut-curly-medium" } },
    transparentBackground: true,
  },
  {
    id: "wolf-cut-wavy-medium",
    kind: "image",
    image: wolfCutWavyMedium,
    alt: "Editorial reference showing mid-20s, light skin woman with a wavy shoulder length wolf cut.",
    provenance: { origin: "system", aiGeneration: { provider: "OpenAI", promptKey: "wolf-cut-wavy-medium" } },
    transparentBackground: true,
  },
];
