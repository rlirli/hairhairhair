...
The person page has breadcrumbs, a concise factual introduction, a source-attributed hero, chronological photo entries, capture date and event, original source links, visible hairstyle observations and linked style names. The person also has an `/appearances/` overview with a compact, newest-first card grid; cards link back to their dated entry on the person page until dedicated single-appearance pages exist. A single editorial note explains that the labels are visual interpretations. A small rights note distinguishes copyright status from endorsement/personality rights. Use original wording and keep biography minimal: actor and recording artist is sufficient.
